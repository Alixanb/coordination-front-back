...
| **C2.2.1** | Prototype + sécurité | [architecture.md](architecture.md) · [05-securite-owasp.md](05-securite-owasp.md) |
| **C2.2.2** | Harnais de tests unitaires | [07-cahier-de-recettes.md](07-cahier-de-recettes.md) (§4) · code `*.spec.ts`, `*Test.java` |
| **C2.2.3** | Sécurité OWASP + accessibilité | [05-securite-owasp.md](05-securite-owasp.md) · [06-accessibilite.md](06-accessibilite.md) |
